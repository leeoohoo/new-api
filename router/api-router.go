...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/auth/me", controller.GetIAMMe)
		...
		logRoute.GET("/usage_report/trend", middleware.AdminAuth(), controller.GetAdminUsageTrend)
		logRoute.GET("/usage_report/model", middleware.AdminAuth(), controller.GetAdminUsageByModel)
		logRoute.GET("/usage_report/channel", middleware.AdminAuth(), controller.GetAdminUsageByChannel)
		logRoute.GET("/usage_report/user", middleware.AdminAuth(), controller.GetAdminUsageByUser)
